...
Before continuing, further lines of text needed to be removed in order to make the data more amenable to analysis.
...
From the now processed data-frame, only the *Year*, and the **total** *Woodland Area* (in thousand hectares) of each country, per year, need to be extracted for the visualisation. All of the data on the amount of woodland area also needed to be used to calculate the percentage increase from 1998 to 2023 for each country.
